...
// @match           http://*.nettruyenvv.com/*
// @match           https://*.nettruyenup.vn/*
// @match           http://*.nettruyenco.vn/*
// @match           https://*.nettruyenviet.com/*
// @match           http://*.nettruyen.net.vn/*
// @match           https://*.nettruyenclub.net/*
// @match           http://*.nettruyentt.com/*
// @match           https://*.nettruyenus.com/*
// @match           http://*.nettruyentr.vn/*
// @match           https://*.nettruyenfull.com/*
// @match           https://mangaxy.com/*
// @match           https://*.doctruyenonline.vn/*
// @match           https://*.nucomic.com/*
// @match           https://*.truyenkinhdi.net/*
// @match           https://*.blogtruyenvn.org/*
// @match           https://*.blogtruyenvn.vn/*
